...
class MentalHealth(commands.cog):
    ...
    async def distraction(self, ctx):
        distractionslist = random.choice([
            """Bored or in need of a distraction?\nTry checking out this website, there are some really cool videos on it:\n\nhttps://www.ted.com/""",
            """Bored or in need of a distraction?\nTry checking out this website! Make someone you know with one of the games on here, then post the result ;)\n\nhttp://www.rinmarugames.com/""",
            """Bored or in need of a distraction?\nTry checking out this website, I promise it's very wholesome:\n\nhttp://emergencycompliment.com/""",
            """Bored or in need of a distraction?\nTry checking out this website, especially if you need to clear your mind:\n\nhttp://www.pixelthoughts.co/""",
            """Bored or in need of a distraction?\nTry checking out this website for suggestions:\n\nhttps://www.wikihow.com/Distract-Yourself""",
            """Bored or in need of a distraction?\nTry checking out this website for some *useless* fun:\n\nhttps://theuselessweb.com/""",
            """Bored or in need of a distraction?\nTry checking out this website and press the button:\n\nhttps://www.boredbutton.com/""",
            """Bored or in need of a distraction?\nTry checking out this website for some *pointless* fun:\n\nhttp://www.pointless.com/""",
            """Bored or in need of a distraction?\nTry checking out this website for some weird, confusing content:\n\nhttps://weirdorconfusing.com/""",
            """Bored or in need of a distraction?\nTry checking out this website and draw (quick!):\n\nhttps://quickdraw.withgoogle.com/""",
            """Bored or in need of a distraction?\nTry checking out this website and have fun with others:\n\nhttps://goo.gl/11aeqc""",
            """Bored or in need of a distraction?\nTry checking out this website for a random doggo:\n\nhttps://random.dog/""",
            """Bored or in need of a distraction?\nTry checking out this website for some doggos:\n\nhttps://dogperday.com/""",
            """Bored or in need of a distraction?\nTry checking out this website for a random kitty cat:\n\nhttp://random.cat""",
            """Bored or in need of a distraction?\nTry checking out this website if you like reading:\n\nhttp://www.whatshouldireadnext.com/""",
            """Bored or in need of a distraction?\nTry checking out this website... if you like sloths:\n\nhttp://sloths.arerad.com/""",
            """Bored or in need of a distraction?\nTry checking out this website for some "The Office" stares:\n\nhttp://theofficestaremachine.com/""",
            """Bored or in need of a distraction?\nTry checking out this website and... draw a circle:\n\nhttp://vladgotlib.com/circular/""",
            """Bored or in need of a distraction?\nTry checking out this website for some funny or interesting news:\n\nhttp://www.collegehumor.com/tbt""",
            """Bored or in need of a distraction?\nTry checking out this website for baby animals:\n\nhttps://www.zooborns.com/""",
            """Bored or in need of a distraction?\nTry checking out this website for a random catto:\n\nhttp://random.cat""",
            """Bored or in need of a distraction?\nTry checking out this website for cute websites:\n\nhttp://www.supercutekawaii.com/super-cute-sites/""",
        ])
